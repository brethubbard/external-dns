...
type Config struct {
	...
	NextDNSAPIKey                      string `secure:"yes"`
...
func (cfg *Config) ParseFlags(args []string) error {
	...
	// Flags related to the NextDNS provider
